    ...
    <div class="imgWrapper-card">
      <picture>
        <source media="(min-width: 768px)"
          srcset="<?php echo esc_url(get_theme_file_uri($element['serviceImg'])); ?>@2x.jpg" width="335" height="170">
        ...
        <source
          media="(max-width: 767px) and (-webkit-min-device-pixel-ratio: 3), (max-width: 767px) and (min-resolution: 384dpi)"
          srcset="<?php echo esc_url(get_theme_file_uri($element['serviceImg'])); ?>-sp@3x.jpg" width="335"
          height="170">
