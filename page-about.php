...
<main>
  <div class="wrapper">
    ...
    <?php $summarySectionData = [
      ...
      'sectionText' => "弁護士の仕事は、あくまで社会貢献であり、目の前のクライアントの力になるため、揺るぎない社会正義を貫くことが必要です。クライアントが、“何を求め”、“どうしたいのか”、“先々まで考え今どうすることがベストか”、クライアントの目線で寄り添い、時には導き、如何なる状況でも諦めずに一緒に考え続けていくこと、それこそが弁護士の仕事の本質です。"
    ];
    $linkTabDataAbout = [
      [
        'actions' => "#philosophy",
